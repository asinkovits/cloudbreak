...
public interface AccountAwareResourceRepository<T extends AccountAwareResource, ID extends Serializable> extends CrudRepository<T, ID> {
    ...
    Optional<ResourceBasicView> findResourceCrnNameIdByResourceCrn(String resourceCrn);

    List<ResourceBasicView> findAllResourceCrnNameIdByByResourceCrns(Collection<String> resourceCrns);

    Optional<ResourceBasicView> findResourceCrnNameIdByNameAndAccountId(String resourceCrn, String accountId);

    List<ResourceBasicView> findAllResourceCrnNameIdByNamesAndAccountId(Collection<String> names, String accountId);
}
