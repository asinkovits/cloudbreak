...
public class AzurePlatformResources implements PlatformResources {
    ...
    @Override
    public CloudPrivateDnsZones privateDnsZones(ExtendedCloudCredential cloudCredential, Region region, Map<String, String> filters) {
        PagedList<PrivateZone> azurePrivateDnsZones = azureClientService.getClient(cloudCredential).getPrivateDnsZoneList();
        azurePrivateDnsZones.loadAll();
