...
class UpgradeCcmFlowChainIntegrationTest {
    ...
    private static final int CALLED_ONCE_TILL_GENERATE_USERDATE = 17;
    ...
    public void testUpdateUserDataFailsInChain() throws Exception {
        ...
        testFlow(CALLED_ONCE_TILL_GENERATE_USERDATE, true, false);
    }
    ...
    private void testFlow(int calledOnceTillUpgrade, boolean ccmUpgradeSuccess, boolean userDataUpdateSuccess) throws Exception {
        FlowIdentifier flowIdentifier = triggerFlow();
        letItFlow(flowIdentifier);

        flowFinishedSuccessfully(ccmUpgradeSuccess ? 2 : 1);
        verifyServiceCalls(calledOnceTillUpgrade);
    ...
    private void verifyServiceCalls(int tillInt) throws Exception {
    ...
    private void flowFinishedSuccessfully(int numberOfFlows) {
        ArgumentCaptor<FlowLog> flowLog = ArgumentCaptor.forClass(FlowLog.class);
        verify(flowLogRepository, times(2 * numberOfFlows)).save(flowLog.capture());
