...
class UpdateUserDataFlowIntegrationTest {
    ...
    private static final int CALLED_ONCE_TILL_GENERATE_USERDATE = 1;
    ...
    public void testUserDataUpdateWhenNewUserDataFails() throws Exception {
        ...
        testFlow(CALLED_ONCE_TILL_GENERATE_USERDATE, false);
    }

    private void testFlow(int calledOnceTillUpgrade, boolean b) throws Exception {
        FlowIdentifier flowIdentifier = triggerFlow();
        letItFlow(flowIdentifier);

        flowFinishedSuccessfully();
        verifyServiceCalls(calledOnceTillUpgrade);
        verifyFinishingStatCalls(b);
    }
