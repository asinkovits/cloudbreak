...
public interface CDPStructuredEventRepository extends AccountAwareResourceRepository<CDPStructuredEventEntity, Long> {
    ...
    default Optional<ResourceBasicView> findResourceCrnNameIdByResourceCrn(String resourceCrn) {
        throw new UnsupportedOperationException();
    }

    default List<ResourceBasicView> findAllResourceCrnNameIdByByResourceCrns(Collection<String> resourceCrns) {
        throw new UnsupportedOperationException();
    }

    default Optional<ResourceBasicView> findResourceCrnNameIdByNameAndAccountId(String resourceCrn, String accountId) {
        throw new UnsupportedOperationException();
    }

    default List<ResourceBasicView> findAllResourceCrnNameIdByNamesAndAccountId(Collection<String> names, String accountId) {
        throw new UnsupportedOperationException();
    }
