...
class StackPatchServiceTest {
    ...
    @Test
    void createIfNotExistsShouldNotCreateWhenExists() {
        ...
        StackPatch result = underTest.createIfNotExists(STACK_ID, STACK_PATCH_TYPE);
    ...
    @Test
    void createIfNotExistsShouldCreateWhenDoesNotExist() {
