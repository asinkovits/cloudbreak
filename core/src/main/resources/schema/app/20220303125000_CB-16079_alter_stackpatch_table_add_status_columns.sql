...
DELETE FROM stackpatch WHERE status != 'FIXED';
ALTER TABLE stackpatch DROP COLUMN IF EXISTS status;

ALTER TABLE stackpatch DROP COLUMN IF EXISTS status_reason;
