...
public interface StackRepository extends WorkspaceResourceRepository<Stack, Long>, JobResourceRepository<Stack, Long> {
    ...
    Optional<ResourceBasicView> findResourceCrnNameIdByResourceCrn(@Param("resourceCrn") String resourceCrn);
    ...
    List<ResourceBasicView> findAllResourceCrnNameIdByByResourceCrns(@Param("resourceCrns") Collection<String> resourceCrns);
    ...
    Optional<ResourceBasicView> findResourceCrnNameIdByNameAndAccountId(@Param("name") String name, @Param("workspaceId") Long workspaceId);
    ...
    @Query("SELECT s.id as id, s.resourceCrn as resourceCrn, s.name as name " +
            ...
            "AND s.name in (:names) " +
            "AND w.id = :workspaceId")
    List<ResourceBasicView> findAllResourceCrnNameIdByNamesAndAccountId(@Param("names") Collection<String> names, @Param("workspaceId") Long workspaceId);
}
