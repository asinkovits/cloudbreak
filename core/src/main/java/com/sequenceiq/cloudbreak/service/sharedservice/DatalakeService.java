...
public class DatalakeService implements HierarchyAuthResourcePropertyProvider {
    ...
    public void prepareDatalakeRequest(Stack source, StackV4Request stackRequest) {
        if (!Strings.isNullOrEmpty(source.getDatalakeCrn())) {
            ...
            Optional<ResourceBasicView> datalakeStack = stackService.getResourceCrnNameIdByResourceCrn(source.getDatalakeCrn());
    ...
    public void addSharedServiceResponse(ClusterApiView cluster, ClusterViewV4Response clusterResponse) {
        ...
        if (cluster.getStack().getDatalakeCrn() != null) {
            ...
            Optional<ResourceBasicView> datalakeStack = stackService.getResourceCrnNameIdByResourceCrn(cluster.getStack().getDatalakeCrn());
            datalakeStack.ifPresent(s -> {
    ...
    public void addSharedServiceResponse(Stack stack, StackV4Response stackResponse) {
        ...
        if (!Strings.isNullOrEmpty(stack.getDatalakeCrn())) {
            ...
            Optional<ResourceBasicView> resourceBasicView = stackService.getResourceCrnNameIdByResourceCrn(stack.getDatalakeCrn());
