...
public class StackPatchService {
    ...
    public StackPatch createIfNotExists(Stack stack, StackPatchType stackPatchType) {
        StackPatch stackPatch = createIfNotExists(stack.getId(), stackPatchType);
        stackPatch.setStack(stack);
        return stackPatch;
    }

    public StackPatch createIfNotExists(Long stackId, StackPatchType stackPatchType) {
